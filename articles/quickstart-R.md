...
git_commit("Initial project setup with analysis profile")
...
# Validate package consistency (runs zzrenvcheck in the container)
...
if (validate_repro()) {
  ...
  message("Package consistency verified by zzrenvcheck")
} else {
...
system("make check-renv")  # Runs zzrenvcheck in the container
