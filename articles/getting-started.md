...
**analysis**: Data analysis environment (~1.2GB, recommended) - Base:
rocker/tidyverse - Packages: renv, devtools, tidyverse, here
...
reproducibility. The check is implemented by the companion R package
`zzrenvcheck`, which is installed into the project image.
