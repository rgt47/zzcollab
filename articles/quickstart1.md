...
>   into the container): minimal, analysis, or rstudio. Distinct from
>   the archetype.
...
For specialised needs (LaTeX, modeling, Shiny), start with the closest
one and add packages inside the container with
