...
test_that("function parameters are properly validated", {
  ...
  expect_error(init_project(), "argument \"team_name\" is missing")
  expect_error(init_project("team"), "argument \"project_name\" is missing")
  expect_error(join_project(), "argument \"team_name\" is missing")
  expect_error(join_project("team"), "argument \"project_name\" is missing")
})
