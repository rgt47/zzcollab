...
- `modeling` - Machine learning with tidymodels (~1.5GB)
- `publishing` - LaTeX + Quarto manuscripts (~3GB)
- `rstudio` - RStudio Server (~980MB)
- `shiny` - Shiny Server (~1.8GB)
...
- Examples: `minimal`, `analysis`, `modeling`, `publishing`, `rstudio`, `shiny`
