...
3. Result: `~/dotfiles/vimrc` becomes `/home/rstudio/.vimrc` in container
...
# Only flag needed:
# -I shell: Use shell interface (or rstudio for RStudio Server)
#
# These come from config (set in Step 1):
...
Inside the container, create your analysis as an Rmd file:
...
# Create analysis report as Rmarkdown using writeLines
writeLines(c(
  "---",
...
), con = "analysis/report/report.Rmd")
