...
zzcollab -t rgt47 -p penguin-bills -I shell -F -G -D ~/dotfiles

# Additional flags:
# -I shell: Use shell interface (or rstudio for RStudio Server)
# -G: Create GitHub repository automatically
# -D ~/dotfiles: Include dotfiles (files WITHOUT leading dots)
```
...
zzcollab -t rgt47 -p penguin-bills -I shell -F -D ~/dotfiles
gh repo create rgt47/penguin-bills --private --source=. --remote=origin --push
```
