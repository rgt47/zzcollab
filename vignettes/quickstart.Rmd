...
Team members can add R packages to the analysis (updates renv.lock):
...
# STEP 1: Validate dependencies (RECOMMENDED - prevents CI failures)
make check-renv-ci
...
# STEP 1: Validate dependencies (catch issues before CI runs)
make check-renv-ci
