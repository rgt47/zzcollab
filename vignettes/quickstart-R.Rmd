...
**Note**: ZZCOLLAB now features auto-snapshot on container exit, so manual `renv::snapshot()` is typically unnecessary.
...
system("Rscript validate_package_environment.R")
