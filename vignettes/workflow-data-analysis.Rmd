...
**Tip**: Use `make r` if you prefer to work directly in R. Use `make docker-sh` if you need shell access for running multiple scripts.
...
Want to share your analysis as a blog post? ZZCOLLAB projects integrate seamlessly with Quarto blogs:
...
The setup script creates a dual-symlink structure that lets Quarto find your `index.qmd` while you work in the familiar `analysis/paper/` directory.
