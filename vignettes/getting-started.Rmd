...
- Base: rocker/r-ver
- Packages: tidymodels, xgboost, randomForest, glmnet, caret

**publishing**: Document publishing with LaTeX and Quarto (~3GB)
- Base: rocker/verse
- Packages: quarto, bookdown, distill, flexdashboard
...
| modeling       | ~1.5GB   | Machine learning              | rocker/r-ver       |
| publishing     | ~3GB     | LaTeX/Quarto publishing       | rocker/verse       |
