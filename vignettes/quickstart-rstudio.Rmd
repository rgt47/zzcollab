...
- **Saved:** All file edits, created files, installed packages (auto-captured in renv.lock on exit)
...
# Option A: Pull team Docker image (fast: 1-3 min, requires DockerHub setup)
