...
**Then validate dependencies** - Switch to Terminal pane in RStudio:
```bash
# In Terminal pane (bottom-left, next to Console):
Rscript validate_package_environment.R --fix
```

**RStudio Advantage:** You can also install using the Packages pane:
1. Click "Packages" tab (bottom-right)
2. Click "Install"
3. Type package name
4. Click "Install"
5. Then validate in Terminal pane: `Rscript validate_package_environment.R --fix`
...
# Switch to Terminal pane and run:
# Rscript validate_package_environment.R --fix  # Save package versions
```
...
- Validation: `Rscript validate_package_environment.R`
...
# Then validate in Terminal pane:
# Rscript validate_package_environment.R --fix
```
