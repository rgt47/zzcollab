...
**Docker Profile System for Package Development:**
...
# Method 4: Custom profile selection for specialized requirements
mkdir my-analysis-package && cd my-analysis-package
zzcollab -p my-analysis-package -P package    # Local project setup
./add_profile.sh    # Select additional variants like rhub or alpine_minimal
```
...
make r         # Command-line interface (recommended)
