...
## Configuration and Profile System Overview
...
- **Interactive Management**: `./add_profile.sh` utility provides guided
...
- **Build Settings**: Package selection modes, paradigm defaults
- **Docker Management**: Profile selection, platform compatibility, resource
  constraints
...
*For comprehensive configuration documentation, see [Configuration Guide](../docs/CONFIGURATION.md) and [Profile System Guide](../docs/VARIANTS.md)*
...
# Method 4: Custom profile selection for specialized needs
mkdir penguin-analysis && cd penguin-analysis
zzcollab -p penguin-analysis -P analysis    # Local project setup
./add_profile.sh    # Select additional variants like modeling or alpine_minimal
```
...
make r         # Command-line interface (most flexible)
...
- **Technical Flexibility**: Multiple Docker profiles accommodate diverse computational requirements
