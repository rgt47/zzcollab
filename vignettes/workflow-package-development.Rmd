...
This vignette demonstrates the recommended workflow for R package development using ZZCOLLAB, following the unified research compendium framework [@marwick_packaging_2018] and R package development best practices [@wickham_r_2015].

**Key Philosophy**: Use the **same structure** for package development as data analysis. No separate "package paradigm"—just add package infrastructure progressively as needed [@marwick_packaging_2018].

## What You Will Learn

- Developing R packages following rrtools conventions
- Test-driven development with comprehensive coverage [@wickham_testthat_2011]
- Documentation with roxygen2 [@wickham_r_2015]
...
- Familiarity with R package structure [@wickham_r_2015]
...
**ZZCOLLAB approach** [@marwick_packaging_2018]: **Same structure, progressive disclosure**.
...
**No migration needed**—add CRAN infrastructure when ready [@wickham_r_2015].

## When to Develop as a Package

Develop as a package when [@wickham_r_2015]:
...
The package development workflow starts **identically** to data analysis [@marwick_packaging_2018].
...
**Key insight**: This is **exactly the same structure** as data analysis. The only difference is **what you put in R/** [@marwick_packaging_2018].

## Step 2: Develop Functions with Tests (TDD Approach)

Following test-driven development [@wickham_testthat_2011], write tests first, then implement functions.
...
Comprehensive documentation is essential for package users [@wickham_r_2015].
...
Vignettes provide long-form documentation for package workflows [@wickham_r_2015].
...
CRAN has strict requirements for package submission [@wickham_r_2015].
...
Achieve >95% test coverage following best practices [@wickham_testthat_2011].
...
Ensure tests cover [@wickham_testthat_2011]:
...
Final steps for CRAN submission [@wickham_r_2015].
...
Create professional package documentation website [@wickham_r_2015].
...
Following R package development best practices [@wickham_r_2015; @wickham_testthat_2011]:
...
If you already have analysis code, the progression is natural [@marwick_packaging_2018]:
...
At every stage, you **never rebuild the project**. Just **add what you need, when you need it** [@marwick_packaging_2018].
