...
├── data/
│   ├── raw_data/             # Original datasets (read-only)
│   └── derived_data/         # Processed data products
├── outputs/
...
customer_data <- readRDS(here("data", "derived_data", "processed_customer_data.rds"))
...
raw_data <- readRDS(here("data", "raw_data", "customer_data.rds"))
