...
We analyzed morphological measurements from `r nrow(penguins_clean)` penguins representing three species: Adelie (n = `r sample_counts["Adelie"]`), Chinstrap (n = `r sample_counts["Chinstrap"]`), and Gentoo (n = `r sample_counts["Gentoo"]`) collected between 2007-2009 in the Palmer Archipelago, Antarctica.
