...
zzcollab -t climate-team -p precipitation --profile-name geospatial -d ~/dotfiles
...
zzcollab -t myname -p mypackage --profile-name analysis -d ~/dotfiles --create-github-repo
