...
# Save dependency state (manual or automatic)
renv::snapshot()  # Updates renv.lock

# Note: In ZZCOLLAB Docker containers, snapshot happens automatically on exit!
# See Level 3 for auto-snapshot workflow
...
# NEW: Auto-snapshot architecture (October 2025)
