...
make docker-push-team
git add .
git commit -m "Create standard team base image"
git push -u origin main
cd ..
...
make docker-push-team
git add .
git commit -m "Create fast team base image"
git push -u origin main
cd ..
```
...
make docker-push-team
git add .
git commit -m "Create RStudio team base image"
git push -u origin main
cd ..
...
make docker-push-team
git add .
git commit -m "Create shell-only team base image"
git push -u origin main
cd ..
```
...
zzcollab -t genomicslab -p labbase -C --profile-name rstudio -d ~/dotfiles
make docker-build
make docker-push-team
git add .
...
# Builds genomicslab/labbase:latest with Bioconductor packages
```
...
zzcollab -t datasci-firm -p q1-2025-base -C --profile-name rstudio -d ~/dotfiles
make docker-build
make docker-push-team
git add .
...
zzcollab -t mylab -p bio-base -C --profile-name rstudio -d ~/dotfiles
make docker-build
make docker-push-team
git add .
...
zzcollab -t mylab -p geo-base -C --profile-name rstudio -d ~/dotfiles
make docker-build
make docker-push-team
git add .
...
zzcollab -t mylab -p ml-base -C --profile-name rstudio -d ~/dotfiles
make docker-build
make docker-push-team
git add .
...
mkdir shiny-base && cd shiny-base
zzcollab -t mylab -p shiny-base -C --profile-name rstudio -d ~/dotfiles
make docker-build
make docker-push-team
git add .
git commit -m "Create web apps base image"
git push -u origin main
cd ..
...
zzcollab -t mylab -p base-2025-01 -C --profile-name rstudio -d ~/dotfiles
make docker-build
make docker-push-team
git add .
...
zzcollab -t mylab -p baseimage-test -C --profile-name rstudio -d ~/dotfiles
make docker-build
make docker-push-team
git add .
