...
2. **Push to Docker Hub** (optional): Store the image in a central repository for faster team setup
3. **Reuse everywhere**: New projects use your team image as the base (~30 seconds setup)

**Note**: Pushing images to Docker Hub is optional. Team members can alternatively build from the Dockerfile committed to the repository. Pushing images provides faster setup times but requires Docker Hub access.
...
zzcollab -t mylab -p study1 --profile-name analysis -d ~/dotfiles
make docker-build
...
zzcollab -t mylab -p study2 --profile-name analysis -d ~/dotfiles
make docker-build
make docker-push-team
cd ..
...
zzcollab -t mylab -p study3 --profile-name analysis -d ~/dotfiles
make docker-build
make docker-push-team
...
zzcollab -t mylab -p baseimage --profile-name analysis -d ~/dotfiles
make docker-build
make docker-push-team
git add .
...
mkdir baseimage && cd baseimage
zzcollab -t mylab -p baseimage --profile-name modeling -d ~/dotfiles
make docker-build
make docker-push-team
git add .
...
mkdir baseimage && cd baseimage
zzcollab -t mylab -p baseimage --profile-name minimal -d ~/dotfiles
make docker-build
make docker-push-team
git add .
...
mkdir baseimage && cd baseimage
zzcollab -t mylab -p baseimage --profile-name bioinformatics -d ~/dotfiles
make docker-build
make docker-push-team
git add .
...
mkdir baseimage && cd baseimage
zzcollab -t mylab -p baseimage --profile-name geospatial -d ~/dotfiles
make docker-build
make docker-push-team
git add .
...
zzcollab -t drsmith -p mybase --profile-name analysis -d ~/dotfiles
make docker-build
make docker-push-team
git add .
...
zzcollab -t genomicslab -p labbase --profile-name bioinformatics -d ~/dotfiles
make docker-build
make docker-push-team
git add .
...
cd rnaseq-analysis
zzcollab --use-team-image  # Or: make docker-build
make docker-rstudio
...
# All 3 researchers ready in ~90 seconds total (using pre-built images)
...
zzcollab -t datasci-firm -p q1-2025-base --profile-name analysis -d ~/dotfiles
make docker-build
make docker-push-team
git add .
...
zzcollab -t mylab -p bio-base --profile-name bioinformatics -d ~/dotfiles
make docker-build
make docker-push-team
git add .
...
zzcollab -t mylab -p geo-base --profile-name geospatial -d ~/dotfiles
make docker-build
make docker-push-team
git add .
...
zzcollab -t mylab -p ml-base --profile-name modeling -d ~/dotfiles
make docker-build
make docker-push-team
git add .
...
zzcollab -t mylab -p pub-base --profile-name publishing -d ~/dotfiles
make docker-build
make docker-push-team
git add .
...
zzcollab -t mylab -p base-2025-01 --profile-name analysis -d ~/dotfiles
make docker-build
make docker-push-team
git add .
...
zzcollab -t mylab -p baseimage-test --profile-name analysis -d ~/dotfiles
make docker-build
make docker-push-team
git add .
