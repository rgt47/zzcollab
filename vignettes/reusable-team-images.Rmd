...
This vignette explains how to create **reusable team Docker images** that reduce project initialization time. Rather than building a new Docker image from rocker base images for each project (15-20 minutes for comprehensive builds), you can:
...
**What this does:**
- Pulls `mylab/study1:latest` from Docker Hub (if available)
- Creates project structure if needed
- Uses the team base image as foundation
- Takes ~1-3 minutes instead of 15-20 minutes

**Note**: DockerHub is optional but efficient. If the team image is not available,
building from the Dockerfile produces an identical environment.
...
| mylab/ml-base | modeling profile | Machine learning | 2025-01-05 |
| mylab/pub-base | publishing profile | LaTeX/Quarto docs | 2024-12-20 |
...
| Machine learning | modeling profile | Tidymodels ML framework |
| Publishing/reports | publishing profile | LaTeX, Quarto, rmarkdown |
...
This approach transforms zzcollab from a per-project build system into a reusable infrastructure platform, improving developer productivity while maintaining reproducibility guarantees.
