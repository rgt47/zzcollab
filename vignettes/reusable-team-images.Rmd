...
mkdir study1 && cd study1
zzcollab --use-team-image        # Fast: pulls pre-built team image
cd ..
...
# Pull and use the team's pre-built Docker image
zzcollab --use-team-image        # Fast: 1-3 min (pulls from Docker Hub)
...
cd cancer-study
zzcollab --use-team-image        # Fast: pulls pre-built team image
# Or: make docker-build          # Always works (5-15 min)
